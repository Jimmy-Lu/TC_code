...
typedef int eid_t;
typedef int vid_t;
typedef int id_thread_t;
typedef eid_t id_shard_t;
typedef vid_t id_interval_t;
...
public:
    ...
    static EPartitioning name_partitioning;
    static EDataset name_dataset;
    static EModel name_model;
    static EFormat shard_format;
    ...
    static int shard_max_element;
    static int shard_max_src_edge;
    static int shard_max_dst;
    static int num_vu;
    static int num_mu;
