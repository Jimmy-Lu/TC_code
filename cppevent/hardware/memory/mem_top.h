...
public:
    ...
    inline void set_ctrl(control::CtrlTop *c) { ctrl = c; }
    inline eid_t get_num_shard() const { return lsu->get_num_shards(); }
    inline eid_t get_num_edges() const { return lsu->get_num_edges(); }
    inline vid_t get_num_vertices() const { return lsu->get_num_vertices(); }
    inline vid_t get_num_interval() const { return lsu->get_num_intervals(); }
