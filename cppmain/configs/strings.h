...
const map<ETU, string> tu_to_string = {
        {ETU::csc,    "csc"},
        {ETU::csr,    "csr"},
        {ETU::bitmap, "bitmap"},
};
const map<string, ETU> string_to_tu = {
        {"csc",    ETU::csc},
        {"csr",    ETU::csr},
        {"bitmap", ETU::bitmap},
};
...
///////////////////////////////
enum class ETiling : int {
    baseline, hygcn, sparse,
};
const map<ETiling, string> tiling_to_string = {
        {ETiling::sparse,   "sparse"},
        {ETiling::baseline, "baseline"},
        {ETiling::hygcn,    "hygcn"}};
const map<string, ETiling> string_to_tiling = {
        {"sparse",     ETiling::sparse},
        {"baseline", ETiling::baseline},
        {"hygcn",    ETiling::hygcn}};
