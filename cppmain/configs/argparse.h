//
// Created by SmartCabbage on 2021/7/30.
//

#ifndef CPPMAIN_ARGPARSE_H
#define CPPMAIN_ARGPARSE_H
            ...
            if (auto expected = maybe_nargs()) {
                if (mIsOptional) {
                    if (mIsUsed && mValues.size() != *expected && !mIsRepeatable &&
                        ...
                        // check if an implicit value was programmed for this argument
